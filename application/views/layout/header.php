...
<html <?php echo $this->customlib->getRTL(); ?>>
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
			...
			<li class="treeview <?php echo set_Topmenu('Employee Information'); ?>">
                <a href="#">
                    <i class="fa fa-users"></i> <span>Employee Information</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <!--<li class=""><a href="<?php echo base_url(); ?>employee/empimport"><i class="fa fa-angle-double-right"></i>Import Employee</a></li>-->
					<li class=""><a href="<?php echo base_url(); ?>employee/create"><i class="fa fa-angle-double-right"></i>Add Employee</a></li>
					<li class=""><a href="<?php echo base_url(); ?>employee/view"><i class="fa fa-angle-double-right"></i>View Employee List</a></li>
