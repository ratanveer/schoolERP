...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Teacher Information <small></small></h1>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">                            
                            <a href="<?php echo site_url('admin/teacher/exportformat') ?>">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-download"></i> <?php echo $this->lang->line('dl_sample_import'); ?></button>
                            </a>
                        </div>
                    </div>
                    <form action="<?php echo site_url('admin/teacher/teacherimport') ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-info pull-right">Import Teacher Data</button>
                        </div>
