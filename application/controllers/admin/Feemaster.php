...
class Feemaster extends Admin_Controller {
    ...
    function assign($id) {
		...
		$address = $this->class_model->getaddress();
		...
		// $addressList = $this->customlib->getAddress();
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
			...
			// print_r($data['permanent_address']);
			// exit();
			//$this->load->model('studentfeemaster_model');
            $resultlist = $this->studentfeemaster_model->searchAssignFeeByClassSection($data['class_id'], $data['section_id'], $id, $data['category_id'], $data['gender'], $data['rte_status'], $data['permanent_address']);
